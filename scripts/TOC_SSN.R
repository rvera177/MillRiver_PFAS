...
TOC <- read_csv("https://raw.githubusercontent.com/rvera177/MillRiver_PFAS/refs/heads/main/data/zyna/TOC_IC_SSN_Set_Up%20-%20Sheet1.csv")
S1 <- TOC #need dplyr loaded in order to pipe. Don't forget lol
